export function checkPlanEmptyFields(obj) {
...
export function checkEmptyFields(formInput) {
    const requiredFields = [formInput.email, formInput.phone, formInput.pan, formInput.aadhar, formInput.password, formInput.confirmPassword];
